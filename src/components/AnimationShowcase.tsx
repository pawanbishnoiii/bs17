...
import office from "@/assets/office-hello-upload.json?url";
import booking from "@/assets/appointment-booking-upload.json?url";
import books from "@/assets/girl-books-upload.json?url";
import hero from "@/assets/super-woman-upload.json?url";
  ...
  return (
    <section className="surface-card daily-motion-card flex items-center gap-3 overflow-hidden p-3.5 sm:gap-4 sm:p-5">
      <div className="grid size-16 shrink-0 place-items-center overflow-hidden rounded-2xl bg-[var(--blue-soft)] sm:size-20">
        <LottiePlayer src={chosen} className="size-20 sm:size-24" />
      </div>
